...
export const resources = [
  {
    ...
    talks: [
      ...
      {
        title: 'All about Tensorflow',
        description: 'In this tutorial you will learn how you can use TensorFlow, an open-source framework for machine learning and other computations on decentralized data. You will walk through several classic machine learning problems while learning about the unique advantages and challenges of the setting. You will also see examples of how TFF can be used to enable new research. After this tutorial, you will be equipped to further experiment with machine learning on your own.',
        links: [
          {
